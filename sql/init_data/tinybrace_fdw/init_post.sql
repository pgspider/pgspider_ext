...
CREATE TABLE loc1 (id INTEGER PRIMARY KEY AUTOINCREMENT, f1 int, f2 text);
CREATE TABLE local_tbl(c1 int, c2 int, c3 text, CONSTRAINT local_tbl_pkey PRIMARY KEY (c1));
...
create table loct3_2 (f1 text, f2 text, f3 varchar(10));
