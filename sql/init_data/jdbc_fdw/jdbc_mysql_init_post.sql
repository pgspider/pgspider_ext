...
create table loct3 (f1 text, f2 text, f3 varchar(10) unique);
...
DROP TABLE IF EXISTS loct11 CASCADE;
DROP TABLE IF EXISTS loct22 CASCADE;
create table parent (id int, a int, b text);
create table loct11 (a int, b text);
create table loct22 (id int, a int, b text);
