...
DROP TABLE IF EXISTS gloc1_post14;
DROP TABLE IF EXISTS a;
DROP TABLE IF EXISTS loct9;
DROP TABLE IF EXISTS loct31;
DROP TABLE if EXISTS loct41;
DROP TABLE if EXISTS loct42;
DROP TABLE if EXISTS loct43;
...
create table loct8 (f1 text, f2 text, f3 text);
create table gloc1 (a int PRIMARY KEY, b int);
create table gloc1_post14 (a int PRIMARY KEY, b int generated always as (a * 2) stored);
CREATE TABLE a (aa TEXT);
CREATE TABLE loct9 (aa TEXT, bb TEXT);
CREATE TABLE parent_tbl (a int, b int);
create table loct31 (f1 text, f2 text, f3 varchar(10));
create table loct41 (f1 int, f2 text);
create table loct42 (f1 int, f2 text);
create table loct43 (f1 int, f2 int, f3 int);
