...
--Testcase 96:
EXPLAIN (VERBOSE, COSTS OFF) SELECT t1.c1, t1.c2, t1.c3, t1.c4, t1.c5, t1.c6, t1.c7, t1.c8 FROM ft1 t1 WHERE c1 IS NULL;        -- NullTest
--Testcase 97:
EXPLAIN (VERBOSE, COSTS OFF) SELECT t1.c1, t1.c2, t1.c3, t1.c4, t1.c5, t1.c6, t1.c7, t1.c8 FROM ft1 t1 WHERE c1 IS NOT NULL;    -- NullTest
--Testcase 98:
...
--Testcase 100:
EXPLAIN (VERBOSE, COSTS OFF) SELECT t1.c1, t1.c2, t1.c3, t1.c4, t1.c5, t1.c6, t1.c7, t1.c8 FROM ft1 t1 WHERE 1 = c1!;           -- OpExpr(r)
--Testcase 101:
...
--Testcase 107:
SELECT a.c1, a.c2, a.c3, a.c4, a.c5, a.c6, a.c7, a.c8, b.c1,b.c2, b.c3, b.c4, b.c5, b.c6, b.c7, b.c8 FROM ft2 a, ft2 b WHERE a.c1 = 47 AND b.c1 = a.c2;
...
--Testcase 112:
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT ft2.c1, ft2.c2, ft2.c3, ft2.c4, ft2.c5, ft2.c6, ft2.c7, ft2.c8 FROM ft2 ORDER BY ft2.c1, random();
--Testcase 113:
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT ft2.c1, ft2.c2, ft2.c3, ft2.c4, ft2.c5, ft2.c6, ft2.c7, ft2.c8 FROM ft2 ORDER BY ft2.c1, ft2.c3 collate "C";
...
-- ALTER SERVER mongo_server OPTIONS (ADD use_remote_estimate 'off');
