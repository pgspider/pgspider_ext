...
--Testcase 684:
INSERT INTO ft1 (c1, __spd_url) VALUES (1, '/node1/'); -- ERROR due to not supporting foreign insert.
--Testcase 685:
...
-- conversion error
-- ===================================================================
ALTER FOREIGN TABLE ft1_orig ALTER COLUMN c8 TYPE int;
SET max_parallel_workers_per_gather = 0;
-- Context message must display the alias of child foreign table of fdw.
...
--Testcase 693:
CREATE FOREIGN TABLE remt2_rescan_a_child (c1 int, c2 text) SERVER loopback OPTIONS (table_name 'loct2');
--Testcase 694:
