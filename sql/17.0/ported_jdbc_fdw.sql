...
--Testcase 933:
EXPLAIN (VERBOSE, COSTS OFF)
SELECT * FROM ft1_a_child WHERE c8 = 'foo' LIMIT 1;
--Testcase 934:
SELECT * FROM ft1_a_child WHERE c8 = 'foo' LIMIT 1;
--Testcase 935:
EXPLAIN (VERBOSE, COSTS OFF)
SELECT * FROM ft1_a_child WHERE 'foo' = c8 LIMIT 1;
--Testcase 936:
SELECT * FROM ft1_a_child WHERE 'foo' = c8 LIMIT 1;
...
--Testcase 937:
SELECT * FROM ft1_a_child WHERE c8 LIKE 'foo' LIMIT 1; -- ERROR
--Testcase 938:
SELECT * FROM ft1_a_child WHERE c8::text LIKE 'foo' LIMIT 1; -- ERROR; cast not pushed down
--Testcase 408:
ALTER FOREIGN TABLE ft1_a_child ALTER COLUMN c8 TYPE user_enum;
...
-- ===================================================================
--Testcase 409:
create foreign table loct3_a_child (f1 text collate "C", f2 text, f3 varchar(10)) server :DB_SERVERNAME options (table_name 'loct3');
--Testcase 879:
...
UPDATE ft2_a_child SET c2 = ft2_a_child.c2 + 500, c3 = ft2_a_child.c3 || '_update9', c7 = DEFAULT
  FROM ft1_a_child WHERE ft1_a_child.c1 = ft2_a_child.c2 AND ft1_a_child.c1 % 10 = 9;                               -- can be pushed down
-- --Testcase 432:
UPDATE ft2_a_child SET c2 = ft2_a_child.c2 + 500, c3 = ft2_a_child.c3 || '_update9', c7 = DEFAULT
...
--Testcase 837:
INSERT INTO ft1_a_child(c1, c2) VALUES(11, 12) ON CONFLICT DO NOTHING; -- error
--Testcase 480:
...
CREATE FOREIGN TABLE loct1_a_child (c1 int OPTIONS (key 'true'))
  SERVER :DB_SERVERNAME OPTIONS (table_name 'loct1_rescan');
--Testcase 1002:
...
CREATE FOREIGN TABLE loct2_a_child (c1 int OPTIONS (key 'true'), c2 text)
  SERVER :DB_SERVERNAME OPTIONS (table_name 'loct2_rescan');
--Testcase 1005:
...
--Testcase 523:
CREATE FOREIGN TABLE foreign_tbl_a_child (id serial OPTIONS(key 'true'), a int, b int)
...
--Testcase 667:
CREATE FOREIGN TABLE b_b_child (bb TEXT, id serial OPTIONS(key 'true')) INHERITS (a)
...
SET enable_nestloop to false;
--Testcase 725:
alter foreign table foo2_a_child options (use_remote_estimate 'false');
--Testcase 726:
create index i_foo2_f1 on foo2_a_child(f1);
--Testcase 727:
...
--Testcase 747:
create foreign table loct1_2_a_child (a int OPTIONS (key 'true'), b text)
  server :DB_SERVERNAME options (table_name 'loct11');
--Testcase 901:
create table loct1_2 (a int, b text, spdurl text) PARTITION BY LIST (spdurl);
--Testcase 902:
create foreign table loct1_2_a PARTITION OF loct1_2 FOR VALUES IN ('/node1/') SERVER spdsrv;
--Testcase 748:
create foreign table loct2_2_a_child (a int OPTIONS (key 'true'), b text)
  server :DB_SERVERNAME options (table_name 'loct22');
--Testcase 903:
create table loct2_2 (a int, b text, spdurl text) PARTITION BY LIST (spdurl);
--Testcase 904:
create foreign table loct2_2_a PARTITION OF loct2_2 FOR VALUES IN ('/node1/') SERVER spdsrv;
--Testcase 749:
