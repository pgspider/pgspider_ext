...
CREATE FOREIGN TABLE ft1_a_child (
	c0 int,
	c1 int OPTIONS (key 'true') NOT NULL,
	c2 int NOT NULL,
	c3 text,
	-- c4 timestamptz,
	c5 timestamp,
...
--Testcase 514:
ALTER FOREIGN TABLE ft1_a_child OPTIONS (SET filename :'var');
--Testcase 323:
EXPLAIN (VERBOSE, COSTS OFF) EXECUTE st6;
--Testcase 324:
EXECUTE st6;
...
--Testcase 343:
create foreign table loct3_a_child (f1 text collate "C", f2 text, f3 varchar(10))
  server parquet_s3_srv options (filename :'var');
--Testcase 518:
create table loct3 (f1 text, f2 text, f3 varchar(10), spdurl text) PARTITION BY LIST (spdurl);
--Testcase 519:
...
--Testcase 368:
CREATE FOREIGN TABLE ft1_null_a_child (
	c1 int NOT NULL,
	c2 int NOT NULL,
	c3 text,
	c5 timestamp,
...
--Testcase 523:
CREATE FOREIGN TABLE ft1_null_a PARTITION OF ft1_null FOR VALUES IN ('/node1/') SERVER spdsrv;
...
-- change (bug #17889)
\set var :PATH_FILENAME'/ported_postgres/loct1_rescan.parquet'
--Testcase 893:
create foreign table loct1_a_child (c1 int)
  server parquet_s3_srv options (filename :'var');
--Testcase 894:
...
\set var :PATH_FILENAME'/ported_postgres/loct2_rescan.parquet'
--Testcase 896:
create foreign table loct2_a_child (c1 int, c2 text)
  server parquet_s3_srv options (filename :'var');
--Testcase 897:
...
--Testcase 384:
CREATE FOREIGN TABLE base_tbl_a_child (a int, b int)
  SERVER parquet_s3_srv OPTIONS (filename :'var');
...
-- Parquet_S3_FDW does not support query cancel feature.
